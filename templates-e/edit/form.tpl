<form name="edit-RSS" action="" method="post">
	<div class="col-md-12">
		<!-- RSS Name -->
		<div class="form-group">
			<label for="inputName">{c2r-name}</label>
			<input name="name" type="text" class="form-control" id="inputName" placeholder="" value="{c2r-name}">
		</div>
		<!-- END RSS Name -->
		...
		<div class="form-group">
			...
			<input name="url" type="text" class="form-control" id="inputUrl" placeholder="" value="{c2r-url}">
		</div>
		<!-- END RSS Url -->
		...
		<div class="checkbox sm-taright">
			<label><input type="checkbox" name="status" {c2r-published-checked} value="1"/> {c2r-published}</label>
		</div>
		<!-- END RSS Published -->
